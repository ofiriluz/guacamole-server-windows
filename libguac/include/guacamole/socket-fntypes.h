 ...
 */
typedef size_t guac_socket_read_handler(guac_socket* socket,
 ...
 */
typedef size_t guac_socket_write_handler(guac_socket* socket,
 ...
 */
typedef size_t guac_socket_flush_handler(guac_socket* socket);
...
typedef void guac_socket_reset_handler(guac_socket* socket);
