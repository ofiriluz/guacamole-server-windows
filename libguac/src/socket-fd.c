 ...
 */
size_t guac_socket_fd_write(guac_socket* socket,
 ...
 */
static size_t guac_socket_fd_read_handler(guac_socket* socket,
 ...
 */
static size_t guac_socket_fd_flush(guac_socket* socket) {
 ...
 *     Zero if the flush operation was successful, non-zero otherwise.
 */
static size_t guac_socket_fd_flush_handler(guac_socket* socket) {
 ...
 *     during write.
 */
static size_t guac_socket_fd_write_buffered(guac_socket* socket,
        const void* buf, size_t count) {
 ...
 */
static size_t guac_socket_fd_write_handler(guac_socket* socket,
        const void* buf, size_t count) {
