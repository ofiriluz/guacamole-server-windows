 ...
 *     read.
 */
static size_t __guac_socket_broadcast_read_handler(guac_socket* socket,
 ...
 *     specified by count.
 */
static size_t __guac_socket_broadcast_write_handler(guac_socket* socket,
 ...
 */
static size_t __guac_socket_broadcast_flush_handler(guac_socket* socket) {
...
guac_socket* guac_socket_broadcast(guac_client* client) 
{
    ...
    guac_socket_broadcast_data* data =
        static_cast<guac_socket_broadcast_data*>(malloc(sizeof(guac_socket_broadcast_data)));
