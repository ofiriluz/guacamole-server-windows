...
size_t __guac_socket_nest_write_handler(guac_socket* socket,
...
guac_socket* guac_socket_nest(guac_socket* parent, int index) {
    ...
    __guac_socket_nest_data* data = static_cast<__guac_socket_nest_data*>(malloc(sizeof(__guac_socket_nest_data)));
