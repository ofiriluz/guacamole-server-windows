...
guac_user* guac_user_alloc() {
    ...
    guac_user* user = static_cast<guac_user*>(calloc(1, sizeof(guac_user)));
    int i;
    ...
    /* Initialze streams */
    user->__input_streams = static_cast<guac_stream*>(malloc(sizeof(guac_stream) * GUAC_USER_MAX_STREAMS));
    user->__output_streams = static_cast<guac_stream*>(malloc(sizeof(guac_stream) * GUAC_USER_MAX_STREAMS));
    ...
    /* Initialize objects */
    user->__objects = static_cast<guac_object*>(malloc(sizeof(guac_object) * GUAC_USER_MAX_OBJECTS));
