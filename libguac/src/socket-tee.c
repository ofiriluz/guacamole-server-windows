 ...
 */
static size_t __guac_socket_tee_read_handler(guac_socket* socket,
 ...
 *     error occurs.
 */
static size_t __guac_socket_tee_write_handler(guac_socket* socket,
 ...
 *     socket.
 */
static size_t __guac_socket_tee_flush_handler(guac_socket* socket) {
...
guac_socket* guac_socket_tee(guac_socket* primary, guac_socket* secondary) {
    ...
    guac_socket_tee_data* data = static_cast<guac_socket_tee_data*>(malloc(sizeof(guac_socket_tee_data)));
