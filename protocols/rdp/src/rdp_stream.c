...
int guac_rdp_upload_file_handler(guac_user* user, guac_stream* stream,
    ...
    /* Init upload status */
    rdp_stream = static_cast<guac_rdp_stream*>(
		malloc(sizeof(guac_rdp_stream)));
...
int guac_rdp_svc_pipe_handler(guac_user* user, guac_stream* stream,
    ...
    /* Init stream data */
    stream->data = rdp_stream = static_cast<guac_rdp_stream*>(
		malloc(sizeof(guac_rdp_stream)));
...
int guac_rdp_download_get_handler(guac_user* user, guac_object* object,
    ...
    if (file->attributes & FILE_ATTRIBUTE_DIRECTORY) {
        ...
        /* Create stream data */
        guac_rdp_stream* rdp_stream = static_cast<guac_rdp_stream*>(
			malloc(sizeof(guac_rdp_stream)));
