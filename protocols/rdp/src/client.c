...
#ifdef HAVE_BOOST
extern "C" __declspec(dllexport) int guac_client_init(guac_client* client, int argc, char** argv) 
#elif defined HAVE_LIBPTHREAD
...
#endif
{
    ...
    /* Alloc client data */
    guac_rdp_client* rdp_client = static_cast<guac_rdp_client*>(
		calloc(1, sizeof(guac_rdp_client)));
