...
guac_rdp_dvc_list* guac_rdp_dvc_list_alloc() {
    ...
    guac_rdp_dvc_list* list = static_cast<guac_rdp_dvc_list*>(
		malloc(sizeof(guac_rdp_dvc_list)));
...
void guac_rdp_dvc_list_add(guac_rdp_dvc_list* list, const char* name, ...) {
    ...
    guac_rdp_dvc* dvc = static_cast<guac_rdp_dvc*>(
		malloc(sizeof(guac_rdp_dvc)));
    ...
    dvc->argv = (char**)malloc(sizeof(char*) * dvc->argc);
