...
guac_common_list* guac_common_list_alloc() {
    ...
    guac_common_list* list = static_cast<guac_common_list*>(
		malloc(sizeof(guac_common_list)));
...
guac_common_list_element* guac_common_list_add(guac_common_list* list,
    ...
    guac_common_list_element* element =
		static_cast<guac_common_list_element*>(malloc(sizeof(guac_common_list_element)));
    element->data = data;
